...
import org.wastaken.kotatsu.api21.backups.ui.backup.BackupDialogFragment
import org.wastaken.kotatsu.api21.backups.ui.restore.RestoreDialogFragment
import org.wastaken.kotatsu.api21.bookmarks.ui.AllBookmarksActivity
import org.wastaken.kotatsu.api21.browser.BrowserActivity
import org.wastaken.kotatsu.api21.browser.cloudflare.CloudFlareActivity
...
import org.wastaken.kotatsu.api21.core.model.appUrl
import org.wastaken.kotatsu.api21.core.model.getTitle
import org.wastaken.kotatsu.api21.core.model.isBroken
...
import org.wastaken.kotatsu.api21.core.model.parcelable.ParcelableMangaListFilter
import org.wastaken.kotatsu.api21.core.model.parcelable.ParcelableMangaPage
import org.wastaken.kotatsu.api21.core.network.CommonHeaders
import org.wastaken.kotatsu.api21.core.parser.external.ExternalMangaSource
...
import org.wastaken.kotatsu.api21.core.ui.dialog.BigButtonsAlertDialog
import org.wastaken.kotatsu.api21.core.ui.dialog.ErrorDetailsDialog
...
import org.wastaken.kotatsu.api21.core.util.ext.getThemeDrawable
...
import org.wastaken.kotatsu.api21.details.ui.DetailsActivity
import org.wastaken.kotatsu.api21.details.ui.pager.ChaptersPagesSheet
import org.wastaken.kotatsu.api21.details.ui.related.RelatedMangaActivity
import org.wastaken.kotatsu.api21.details.ui.scrobbling.ScrobblingInfoSheet
import org.wastaken.kotatsu.api21.download.ui.dialog.DownloadDialogFragment
import org.wastaken.kotatsu.api21.download.ui.list.DownloadsActivity
import org.wastaken.kotatsu.api21.favourites.ui.FavouritesActivity
import org.wastaken.kotatsu.api21.favourites.ui.categories.FavouriteCategoriesActivity
import org.wastaken.kotatsu.api21.favourites.ui.categories.edit.FavouritesCategoryEditActivity
import org.wastaken.kotatsu.api21.favourites.ui.categories.select.FavoriteDialog
import org.wastaken.kotatsu.api21.filter.ui.FilterCoordinator
import org.wastaken.kotatsu.api21.filter.ui.sheet.FilterSheetFragment
import org.wastaken.kotatsu.api21.filter.ui.tags.TagsCatalogSheet
import org.wastaken.kotatsu.api21.history.ui.HistoryActivity
import org.wastaken.kotatsu.api21.image.ui.ImageActivity
import org.wastaken.kotatsu.api21.list.ui.config.ListConfigBottomSheet
import org.wastaken.kotatsu.api21.list.ui.config.ListConfigSection
import org.wastaken.kotatsu.api21.local.ui.ImportDialogFragment
import org.wastaken.kotatsu.api21.local.ui.info.LocalInfoDialog
import org.wastaken.kotatsu.api21.main.ui.MainActivity
import org.wastaken.kotatsu.api21.main.ui.welcome.WelcomeSheet
...
import org.wastaken.kotatsu.api21.reader.ui.colorfilter.ColorFilterConfigActivity
import org.wastaken.kotatsu.api21.reader.ui.config.ReaderConfigSheet
import org.wastaken.kotatsu.api21.scrobbling.common.domain.model.ScrobblerService
import org.wastaken.kotatsu.api21.scrobbling.common.ui.config.ScrobblerConfigActivity
import org.wastaken.kotatsu.api21.scrobbling.common.ui.selector.ScrobblingSelectorSheet
import org.wastaken.kotatsu.api21.search.domain.SearchKind
import org.wastaken.kotatsu.api21.search.ui.MangaListActivity
import org.wastaken.kotatsu.api21.search.ui.multi.SearchActivity
import org.wastaken.kotatsu.api21.settings.SettingsActivity
import org.wastaken.kotatsu.api21.settings.about.AppUpdateActivity
import org.wastaken.kotatsu.api21.settings.override.OverrideConfigActivity
...
import org.wastaken.kotatsu.api21.stats.ui.StatsActivity
import org.wastaken.kotatsu.api21.stats.ui.sheet.MangaStatsSheet
import org.wastaken.kotatsu.api21.suggestions.ui.SuggestionsActivity
import org.wastaken.kotatsu.api21.tracker.ui.updates.UpdatesActivity
import java.io.File
